...
from src.data.datasets_stage2 import Stage2TrainDataset, Stage2InferenceDataset
...
class Stage2DataModule(pl.LightningDataModule):
	...
	def setup(self, stage: Optional[str] = None):
		...
		if stage == "fit" or stage is None:
			...
			self.train_ds = Stage2TrainDataset(self.hparams.train_patches_dir)
			self.val_ds = Stage2TrainDataset(self.hparams.val_patches_dir)
		...
		if stage == "predict":
			...
			self.predict_ds = Stage2InferenceDataset(
