...
class QtConfirmCloseProjectDialog(QDialog):
    def __init__(self, parent) -> None:
        ...
        self.setWindowTitle(
            Translater.instance().get_translation("close project title")
        )
        ...
        layout3 = QVBoxLayout()
        layout3.addWidget(QtLabel("close project text"))
    ...
    def accept(self):
        if self.do_not_ask.isChecked():
            ...
            settings.update({"confirm_close_project": False})
        super().accept()
